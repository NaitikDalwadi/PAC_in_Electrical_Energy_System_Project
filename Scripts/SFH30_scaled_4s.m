...
data = readtable('D:\Study\Masters in Automation and IT\Semester 2\PAC in Electrical Energy System\Assignment\load_profile\Dataset\Dynamic_P_Q_15_min_No_PV\SFH30.xlsx');
...
assignin('base', 'load_data_30', output_data);
