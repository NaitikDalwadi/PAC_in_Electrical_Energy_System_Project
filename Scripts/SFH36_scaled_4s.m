...
data = readtable('D:\Study\Masters in Automation and IT\Semester 2\PAC in Electrical Energy System\Assignment\load_profile\Dataset\Dynamic_P_Q_15_min_No_PV\SFH36.xlsx');
...
assignin('base', 'load_data_36', output_data);
